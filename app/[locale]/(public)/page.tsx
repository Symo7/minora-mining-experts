      ...
      <header className="sticky top-0 z-50 border-b border-[#303331] bg-[#080908]/90 backdrop-blur-md px-6 py-3">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <Link href={/ + locale + /admin} className="hover:text-[#C9A45C] transition-colors text-xs text-[#94948D]">Admin Portal</Link>
          </nav>
              ...
              <div className="rounded-xl border border-[#303331] bg-[#171918] p-8 shadow-2xl space-y-6">
                ...
                <div className="space-y-3 text-sm text-[#C8C5BC]">
                  ...
                  <div className="flex justify-between">
                    ...
                    <a href="https://wa.me/12029307553" target="_blank" rel="noopener noreferrer" className="font-medium text-[#34D399] hover:underline">+1 202 930 7553 (Chat)</a>
                  </div>
                  <div className="flex justify-between">
      ...
      <footer className="border-t border-[#303331] bg-[#0F1010] px-6 py-12 text-sm text-[#94948D]">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <img
                src="/brand/minora-logo.jpg"
                alt="Minora Logo"
                className="h-8 w-8 rounded-full object-cover border border-[#C9A45C]/40"
              />
              <span className="font-serif font-bold text-[#F4F1E8]">MINORA MINING EXPERTS</span>
            </div>
            <div className="text-xs text-[#94948D]">&copy; 2026 Minora Mining Experts. All rights reserved.</div>
          </div>
          ...
          <div className="space-y-2 text-xs">
            ...
            <div>
              <span className="text-[#94948D]">WhatsApp Trade Desk: </span>
              <a href="https://wa.me/12029307553" target="_blank" rel="noopener noreferrer" className="text-[#34D399] hover:underline">+1 202 930 7553 (Chat Now ?)</a>
            </div>
            <div>
              <span className="text-[#94948D]">Official Inquiry: </span>
              <a href="mailto:info@minoraminingexperts.com" className="text-[#F4F1E8] hover:underline">info@minoraminingexperts.com</a>
            </div>
          </div>

          <div className="flex flex-wrap gap-4 text-xs">
            <a href="https://www.facebook.com/share/1FbWKanJKZ/" target="_blank" rel="noopener noreferrer" className="hover:text-[#C9A45C] transition-colors">Facebook</a>
            <a href="https://www.instagram.com/minora_mining_experts" target="_blank" rel="noopener noreferrer" className="hover:text-[#C9A45C] transition-colors">Instagram</a>
            <Link href={/ + locale + /gold} className="hover:text-[#F4F1E8] transition-colors">Gold</Link>
            <Link href={/ + locale + /services} className="hover:text-[#F4F1E8] transition-colors">Services</Link>
            <Link href={/ + locale + /trust} className="hover:text-[#F4F1E8] transition-colors">Trust Center</Link>
            <Link href={/ + locale + /quote} className="hover:text-[#F4F1E8] transition-colors">Request Quote</Link>
          </div>
        </div>
      </footer>
    </div>
